...
<!-- css styles -->
      <link rel="stylesheet" type="text/css" href="ancient_styles.css"></link>
    </head>
    <body>
      <header>
        <h1>Ancient Lives</h1>
      ...
      <table summary="a catalogue of ancient scottish sites">
        <caption>Ancient Scottish Sites</caption>
        <thead>
          <tr>
            <th>Site</th>
            <th>Year Built</th>
      ...
      <table summary="iron age period sites">
        <caption>Iron Age Sites</caption>
        <thead>
          <tr>
            <th>Site</th>
            <th>Year Built</th>
